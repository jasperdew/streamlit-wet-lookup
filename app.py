...
def extract_article_text_from_url(url, article_number):
    ...
    for artikel in root.iter('artikel'):
        ...
        if nr_element is not None and nr_element.text and nr_element.text.strip() == article_number:
            al_texts = []
...
if artikel:
    ...
    if st.button("Zoek"):
        ...
        # Toon de resultaten uit de CSV (indien aanwezig)
        ...
        # Toon ook de originele huidige wet, ongeacht of er resultaten zijn
